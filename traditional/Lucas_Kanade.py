...
'''
def optical_flow(old_frame, new_frame, window_size, feature_params):

    feature_list = cv2.goodFeaturesToTrack(old_frame, mask = None, **feature_params)
...
# U, V = optical_flow( img1, img2, 3, feature_params)

# Save results
img2 = cv2.cvtColor( img2, cv2.COLOR_GRAY2RGB)
drawSeperately(img1, img2, U, V, "./results/cat_seperate.jpg")
drawOnFrame(img2, U, V, './results/cat.jpg')